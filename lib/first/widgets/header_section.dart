              ...
              children: [
                ...
                Row(
                  children: [
                    ...
                    const Text('DECEMBER 04, 2020', style: TextStyle(color: Color(0xffA2A2A2), fontSize: appDefaultFontSizes),),
                    const SizedBox(width: 16,),
                    Image.asset('assets/images/ic_time.png', width: iconsSize, height: iconsSize, ),
                    const SizedBox(width: 8,),
                    const Text('20:30', style: TextStyle(color: Color(0xffA2A2A2), fontSize: appDefaultFontSizes,),),
                  ],
                )
              ],
            ),
