...
class HorizontalSnappingList extends StatefulWidget {
  ...
  @override
  State<HorizontalSnappingList> createState() => _HorizontalSnappingListState();
}
...
class SnappingListScrollPhysic extends ScrollPhysics {
  ...
  double _getPixels(ScrollMetrics position, double item) => math.min(item * itemWidth, position.maxScrollExtent);
