...
import 'package:uichallenge/eighth/helper/encryption_helper.dart';
...
class EncryptedFileImage extends ImageProvider<EncryptedFileImage> {
  ...
  ImageStreamCompleter load(EncryptedFileImage key, dynamic decode) {
  ...
  Future<ui.Codec> _loadAsync(
      EncryptedFileImage key, dynamic decode) async {
    assert(key == this);
